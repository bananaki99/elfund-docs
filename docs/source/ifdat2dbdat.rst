...
#. SOURCE_TYPE: Παίρνει την τιμή:
  - 'CDR' όταν τα στοιχεία προέρχονται από τους πίνακες REF.CNTRPRTY, REF.DBT και REF.SHR  
  - 'SDR' όταν τα στοιχεία που προέρχονται από όλους τους άλλους πίνακες πλην των  REF.CNTRPRTY, REF.DBT και REF.SHR.
...
Όσον αφορά τις μετρήσεις LEI_ID, TAX_ID, NBR_ID  αυτές μεταφέρονται στον πίνακα REF.ORG_ALIAS με τον τρόπο που καθορίζεται στη συνέχεια.
